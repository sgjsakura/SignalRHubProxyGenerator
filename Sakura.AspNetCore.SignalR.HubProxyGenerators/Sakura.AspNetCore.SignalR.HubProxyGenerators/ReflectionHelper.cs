...
public static class ReflectionHelper
{
	...
	/// <returns>
	///     If <paramref name="type1" /> equals to <paramref name="type2" />, returns <c>true</c>; otherwise, returns
	///     <c>false</c>.
	/// </returns>
	/// <remarks>
	///     In order to suppress the type mapping difference caused by different assembly version or app domains, this method
	///     uses <see cref="Type.FullName" /> to compare 2 types.
	/// </remarks>
